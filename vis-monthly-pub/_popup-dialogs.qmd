...
We also have an [additional version](../vis-monthly) that also includes the global average out to 85°, as well as several climate monitoring regions used to measure phenomena like the El Niño Southern Oscillation (ENSO) and the Indian Ocean Dipole.
